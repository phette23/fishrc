function tre -d 'Shorthand for tree with colors & hidden files enabled' --wraps tree
    ...
    tree -aC -I '.git|node_modules|.venv|.sass-cache|__pycache__|.pytest_cache|.ruff_cache' --dirsfirst $argv | less -FRNX
end
